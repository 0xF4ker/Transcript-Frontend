	...
	if (!e.TweenLite) {
		...
		(h._init = function () {
			...
			(h._kill = function (a, b, c) {
				if (
					("all" === a && (a = null), null == a && (null == b || b === this.target))
				)
				...
				(d.render = function (t, e, i) {
						...
						(this._totalTime = this._time = u),
							this._reversed ||
								...
								0 === this._duration &&
									...
									this._rawPrevTime !== t &&
									this._first &&
									((h = !0), this._rawPrevTime > r && (o = "onReverseComplete"))),
							(this._rawPrevTime =
					...
					if ((this._time !== f && this._first) || i || h) {
						if (
							...
							this._active ||
								(!this._paused && this._time !== f && t > 0 && (this._active = !0)),
							0 === f &&
								this.vars.onStart &&
								0 !== this._time &&
			...
			return (
				...
				l(
					...
					d(
						...
						function (a) {
							return (
								this._p1 * Math.pow(2, -10 * a) * Math.sin((a - this._p3) * this._p2) +
								1
							);
						},
						0.3
		...
		function (a, b) {
			...
			var k,
				...
				Z = function (a, b) {
					...
					return d >= 0
						? ((Y = 3 === d ? "ms" : c[d]), (X = "-" + Y.toLowerCase() + "-"), Y + a)
						: null;
				},
				...
				aa = (S.convertToPixels = function (a, c, d, e, f) {
					...
					var h,
						...
						o = 1 === d;
					if (
						(n && (d = -d), o && (d *= 100), "%" === e && -1 !== c.indexOf("border"))
					)
						h = (d / 100) * (k ? a.clientWidth : a.clientHeight);
					else {
						if (
							((m.cssText =
								"border:0 solid red;position:" + _(a, "position") + ";line-height:0;"),
			...
			var qa = function (a, b, c, d) {
				...
				sa =
					((S._setPluginRatio = function (a) {
						...
						for (
							var b, c, d, e, f, g = this.data, h = g.proxy, i = g.firstMPT, j = 1e-6;
							i;
			...
			var xa = function (a, b) {
					(b = b || {}),
						...
						(i[a] = i[this.p] = this),
						(this.format =
							b.formatter || qa(b.defaultValue, b.color, b.collapsible, b.multi)),
			...
			var Aa,
				...
				Ra = (S.getTransform = function (a, c, d, e) {
					...
					var f,
						...
						p = 1e5,
						q = Fa
							? parseFloat(_(a, Ea, c, !1, "0 0 0").split(" ")[2]) || m.zOrigin || 0
							: 0,
						...
						if (16 === f.length) {
							...
							m.zOrigin &&
								...
								m.rotationX || m.rotationY
									? (m.skewX = 0)
									: ((m.skewX =
											B || C ? Math.atan2(B, C) * L + m.rotation : m.skewX || 0),
									  Math.abs(m.skewX) > 90 &&
								...
								(z = fa[wa]),
									...
									(A =
										c !== d[z]
											...
											: o - d.ieOffsetY),
									(l[z] =
										(d[z] = Math.round(c - A * (0 === wa || 2 === wa ? 1 : B))) + "px");
						}
					}
				},
				Ta =
			...
			(j = Ga.prototype),
					...
					"transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
					{
						parser: function (a, b, c, d, f, h, i) {
							...
							var l,
								...
								E =
									A.transform &&
									("function" == typeof A.transform ? A.transform(r, q) : A.transform);
				...
				ya("backgroundPosition", {
					...
					parser: function (a, b, c, d, f, g) {
						...
						if (
							...
							for (
								h = q.split(" "), i = r.split(" "), R.setAttribute("src", m), j = 2;
								--j > -1;
				...
				ya("border", {
					...
					formatter: function (a) {
						var b = a.split(" ");
						return (
							b[0] + " " + (b[1] || "solid") + " " + (a.match(pa) || ["#000"])[0]
						);
					},
				}),
				ya("borderWidth", {
...
!(function (a) {
	...
	var b = a.GreenSockGlobals || a,
		...
		j = function (a) {
			return a.length &&
				a[0] &&
				((a[0].nodeType && a[0].style && !a.nodeType) || (a[0].length && a[0][0]))
				? !0
				: !1;
		},
		k = function (a) {
						...
						(p || S || (R && !Q)) &&
							...
							P &&
								(((n._isSplit && p) ||
									(!R && p) ||
									(Q && p) ||
									(!Q && n.parentNode.parentNode === a && !n.parentNode._isSplit)) &&
					...
					(f = g[e]),
						(3 !== f.nodeType || /\S+/.test(f.nodeValue)) &&
							(j &&
								...
								((f.style.display = "inline-block"), (f.style.position = "relative")),
							(f._isSplit = !0),
							G(f, b, c, d));
